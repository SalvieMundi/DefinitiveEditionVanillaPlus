...
The mods will add some strain to your CPU and RAM requirements. GPU requirements will largely be unchanged. Hard drive space will also be unchanged. The installer is roughly 250MB and will install roughly 450MB of content.
...
Below are the 369 individual mods used by this modpack, links to their CurseForge pages or GitHub pages, links to their creator's Patreons or Discords, a short description of what the mod does, and what version is being used. If the mod's source code has been modified, a link to my version of the source code will also be provided.

If you would like to support this modpack, join my Discord for it [here](). I will not accept donations for this modpack. Please support the individual creators here if you feel so inclined.
<br />
